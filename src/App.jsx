...
/* ============================== DASHBOARD PAGE ============================== */
function Dashboard({ devices, totals, activeCount, offlineCount, sim, setSim, simResult }) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between flex-wrap gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-semibold tracking-tight" style={{ color: COLORS.text }}>Welcome back, Alex!</h1>
...
export default function App() {
  ...
  const pages = {
    dashboard: <Dashboard devices={devices} totals={totals} activeCount={activeCount} offlineCount={offlineCount} sim={sim} setSim={setSim} simResult={simResult} />,
